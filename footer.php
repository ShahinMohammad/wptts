			...
			<div class="container">
				<div class="row text-center">
					<div class="col-md-12 col-sm-12 col-xs-12 wow zoomIn">
						<a href="index.html" class="footer-logo"><img src="<?php echo get_template_directory_uri();?>/assets/img/logo.png" alt="logo"></a>
						...
						<p class="footer_copyright">Monalisa &copy; 2016 All Rights Reserved.</p>							
					</div><!--- END COL -->
				</div><!--- END ROW -->
			</div><!--- END CONTAINER -->
		</footer>
...
<!-- Mirrored from ekramit.net/tf/monalisa-spa/monalisa/light-version/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 21 Nov 2016 09:57:43 GMT -->
</html>